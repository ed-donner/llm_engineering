...
1. From the **week6** directory (so `pricer` imports work), open and run:
  - `community-contributions/najeeb/week6_exercise.ipynb`
2. Or in a terminal from the repo root:
  ```bash
   cd week6 && jupyter notebook community-contributions/najeeb/week6_excercise.ipynb
  ```
