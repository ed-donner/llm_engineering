...
PROJECT_NAME = "pricer"
HF_USER = "marufmullah50" # your HF name here! Or use mine if you just want to reproduce my results.
RUN_NAME = "2026-02-16_06.04.59"
PROJECT_RUN_NAME = f"{PROJECT_NAME}-{RUN_NAME}"
REVISION = "6e95e86dc45991331ebde52c805d5a65aff5ab7a"
