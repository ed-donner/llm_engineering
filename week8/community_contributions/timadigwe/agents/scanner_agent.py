...
class ScannerAgent(Agent):
    ...
    # Limit deals per request to stay under OpenRouter token budget
    MAX_DEALS_IN_PROMPT = 5
    ...
    def make_user_prompt(self, scraped) -> str:
        ...
        # Cap number of deals to avoid exceeding token/credit limits
        limited = scraped[: self.MAX_DEALS_IN_PROMPT]
        user_prompt += "\n\n".join([scrape.describe() for scrape in limited])
