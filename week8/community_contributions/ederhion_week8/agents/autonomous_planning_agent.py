...
class AutonomousPlanningAgent(Agent):
    ...
    def estimate_true_value(self, description: str) -> str:
        self.log("Autonomous Planning agent is estimating value via Frontier Agent")
        estimate = self.estimator.price(description)
    ...
    scan_function = {
        ...
        "description": "Returns top vehicle bargains scraped from the internet along with the price each item is being offered for",
        "parameters": {
            "type": "object",
            "properties": {},
    ...
    estimate_function = {
        ...
        "description": "Given the description of a vehicle, estimate how much it is actually worth",
        "parameters": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string",
                    "description": "The description of the vehicle to be estimated",
                },
            },
    ...
    notify_function = {
        ...
        "parameters": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "description": "The description of the vehicle itself scraped from the internet",
                },
                "deal_price": {
                    "type": "number",
    ...
    system_message = "You find great deals on used cars using your tools, and notify the user of the best bargain."
    user_message = """
    First, use your tool to scan the internet for vehicle bargains. Then for each deal, use your tool to estimate its true value.
