...
class TokenPredictor:
    def __init__(self, model_name: str):
        # Initialize OpenAI client with ollama base url and api key
        self.client = OpenAI(base_url=OLLAMA_BASE_URL, api_key='hohoho')
        self.messages = []
        self.predictions = []
...
def visualise_predictions(G: nx.DiGraph, figsize=(14, 80)):
    """
