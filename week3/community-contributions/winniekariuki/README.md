...
- **Gradio UI**: Scenario description, row count, format, prompt style, and model selector; raw output with optional copy/download.
...
4. Open `week3 EXERCISE.ipynb` and run all cells. The Gradio app will launch in your browser.
