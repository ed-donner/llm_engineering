...
- **Gradio UI**: Chat interface with logo, focus (Compliance / Red flags / Hiring), user type (Employer / Worker / Agency), and model switch (GPT-4o-mini, Gemini, Llama 3.2).
- **Streaming** responses.
...
4. Open `week2 EXERCISE.ipynb`, run all cells. Logo loads from `static/logo.png` (or .jpg) if present.
