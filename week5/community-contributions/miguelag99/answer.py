...
SYSTEM_PROMPT = """
You are a knowledgeable, friendly assistant that focuses on information about pokémon and items from the first generation.
You are chatting with a user about pokémon and their characteristics and objects.
...
EXAMPLE:
user: Can you tell me the types of Bulbasaur? -> Query: what are the types of Bulbasaur?
assistant: Bulbasaur is a Grass/Poison type Pokémon.
user: What does the antidote do? -> Query: What are the effects of the antidote item?
...
...
def fetch_context_unranked(question):
    ...
    query = ollama_client.embed(model=EMBED_MODEL, input=[question])['embeddings'][0]
...
def answer_question(question: str, history: list[dict] = []) -> tuple[str, list]:
    ...
    response = completion(model=MODEL, messages=messages, base_url=OLLAMA_SERVER_URL)
