...
- **knowledge_base/** — Markdown documents about AI (what is AI, LLMs, RAG, transformers, embeddings).
...
1. Open `mini_rag_ai_articles.ipynb`.
2. Run all cells in order.
3. Use the `ask("your question?")` cell to query; try questions like “What is RAG?” or “How do transformers use attention?”
