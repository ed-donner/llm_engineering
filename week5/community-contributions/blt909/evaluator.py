...
# Color coding thresholds - Answer (1-5 secs)
ANSWER_GREEN = 4.5
ANSWER_AMBER = 4.0
...
def run_retrieval_evaluation(repo: str, progress=gr.Progress()):
    ...
    for test, result, prog_value in evaluate_all_retrieval(repo):
        count += 1
...
def run_answer_evaluation(repo: str, progress=gr.Progress()):
    ...
    for test, result, prog_value in evaluate_all_answers(repo):
        count += 1
