...
SYSTEM_PROMPT = """
You are a knowledgeable, friendly assistant representing the company AiForAll.
...
With this context, please answer the user's question. Be accurate, relevant and complete. Always make sure to include the source file metadata in your answer, so the user knows where the information is coming from.
"""
...
def rewrite_query(question, history=[]):
    ...
    message = f"""
You are in a conversation with a user, answering questions about the company AiForAll.
...
def merge_chunks(chunks, reranked):
    merged = chunks[:]
    existing = set([chunk.page_content for chunk in chunks])
...
if __name__ == "__main__":
    question = "How to deploy agent to langsmith?"
