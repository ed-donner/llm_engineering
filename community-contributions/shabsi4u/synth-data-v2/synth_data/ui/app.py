"""
Streamlit UI for Synthetic Data Generator MVP.

Multi-tab interface:
- Tab 1: Generate - Main generation interface
- Tab 2: History - Browse and manage past generations
"""
...
def render_api_key_input() -> Optional[str]:
    """
    Render API key input field with security.
