...
def main():
    ...
    with gr.Blocks(title="World Cup 2026 RAG Evaluation Dashboard", theme=theme) as app:
        gr.Markdown("# 📊 World Cup 2026 RAG Evaluation Dashboard")
        gr.Markdown("Evaluate retrieval and answer quality for the World Cup 2026 RAG system")
