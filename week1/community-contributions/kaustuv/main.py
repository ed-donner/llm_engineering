...
async def analyze_writing(draft: WritingDraft):
    try:
        ...
        '''response = client.chat.completions.create(
            model="gpt-4o-mini", 
            messages=[
                {"role": "system", "content": "You are a tutor. Output JSON with keys: 'Overall score out of 25', 'Detailed Feedback': {'Good': '...', 'Improve': '...'}"},
        ...
        Output MUST be a valid JSON object only. No markdown, no code blocks, no preamble.
