...
3.  **Analyze**: Sends cleaned text to Ollama local server to generate 
...
- Use Ollama server and Llama3.2 for the summaries.

Usage:
    Run via: python week1_day2_open_source_queer_currents_digest.py
"""
